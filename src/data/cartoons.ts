...
// `image` recebe a URL do pôster (600x800) assim que as artes forem enviadas.
export type Cartoon = {
  id: string;
  name: string;
  short?: string;
...
export const CARTOONS: Cartoon[] = [
  ...
  { id: "barbie", name: "Barbie", grad: "linear-gradient(160deg,#FF7BC0,#D6167E)", top: true },
  { id: "winx", name: "Winx Club", grad: "linear-gradient(160deg,#F65BAE,#8A46D6)", top: true },
  { id: "superpoderosas", name: "As Meninas Superpoderosas", grad: "linear-gradient(160deg,#7FD4F5,#2563EB)", top: true },
  { id: "frozen", name: "Frozen", grad: "linear-gradient(160deg,#A5E8FF,#3B82F6)", top: true },
  { id: "espias", name: "Três Espiãs Demais", grad: "linear-gradient(160deg,#FFB27A,#EF4444)", top: true },
  ...
  { id: "hellokitty", name: "Hello Kitty", grad: "linear-gradient(160deg,#FFC2DA,#DB2777)" },
  ...
  { id: "bratz", name: "Bratz", grad: "linear-gradient(160deg,#FDA4AF,#9D174D)" },
  { id: "kim", name: "Kim Possible", grad: "linear-gradient(160deg,#FDBA74,#C2410C)" },
  { id: "everafter", name: "Ever After High", grad: "linear-gradient(160deg,#E9D5FF,#6D28D9)" },
  { id: "dora", name: "Dora, a Aventureira", grad: "linear-gradient(160deg,#BBF7D0,#15803D)" },
